...
export default class Home extends Component {
  ...
  buscarPorBairro = (elem) => {
    ...
    this.setState({ totalBairro: response });
    this.setState({ nomeBairro: elem });
    this.setState({ totEleitores: totalEleitores });
    this.setState({ totSessoes: totalSessoes });
  };
    ...
    return (
      <>
        ...
        <ModalDetalhes
          ...
          dados={this.totalBairro}
          bairro={this.nomeBairro}
          eleitores={this.totEleitores}
          sessoes={this.totSessoes}
        />
