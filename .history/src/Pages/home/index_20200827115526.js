...
export default class Home extends Component {
  ...
  changeBairro(event) {
    ...
    this.setState({ searchBairro: this.state.dados.find(bairro => bairro.nome === event.target.value) });
    console.log(this.state.selectedBairro)
  }
          ...
          <Form>
            <Row form>
              ...
              <Col md={6}>
                <Input
                  type="select"
                  onChange={this.changeBairro.bind(Ttis)}
